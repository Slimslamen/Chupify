...
export default function Artists() {
  ...
  const altText = "Test";
  return (
    <div className="mb-10 bg-componentGrey h-full rounded-tl-lg rounded-bl-lg w-[18em] py-6 px-2 overflow-y-auto items-start justify-start flex flex-col space-y-4">
